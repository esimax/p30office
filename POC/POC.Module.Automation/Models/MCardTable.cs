...
{
    public class MCardTable : NotifyObjectBase
    {
        ...
        public MCardTable(object mainView)
        {
        ...
        private void InitCommands()
        {
            ...
            CommandHelp = new RelayCommand(Help, () => ConstantPOCHelpURL.POCHelp16 != "");
        }
        ...
        {
            var w = new WCardTableAddEdit(null) { Owner = DynamicOwner };
        ...
        private void Help()
        {
            System.Diagnostics.Process.Start(ConstantPOCHelpURL.POCHelp16);
        } 
        #endregion
